...
class MVTecDataset(Dataset):
    def __init__(self, root_path='data', class_name='bottle', is_train=False,
        ...
        # load dataset
        self.x, self.y, self.mask = self.load_dataset_folder()  #训练模式下，x为训练集路径，y全为0，mask全为NONE
    ...
    def __getitem__(self, idx):
        ...
        return x, y, mask   #返回预处理后的x,mask和正负样本的label：y
    ...
    def load_dataset_folder(self):
        ...
        img_types = sorted(os.listdir(img_dir))  #good类
